...
<div class="module gallery" data-style="thumbnails">
	...
	<ItemTemplate>
		<li>
			<sf:SitefinityHyperLink class="gallery-list-item" data-popup="true" style='<%# String.Format("background-image: url({0})", Eval("ThumbnailUrl")) %>' runat="server" id="singleItemLink" />
