...
namespace SitefinityWebApp.Widgets.PhotoLightBox.Designer
{
    /// <summary>
    /// Represents a designer for the <typeparamref name="SitefinityWebApp.Widgets.PhotoLightBox.PhotoLightBox"/> widget
    /// </summary>
    public class PhotoLightBoxDesigner : ControlDesignerBase
    {
        #region Properties
        /// <summary>
        ...
        public override string LayoutTemplatePath
        {
            get
            {
                if (string.IsNullOrEmpty(base.LayoutTemplatePath))
                    return PhotoLightBoxDesigner.layoutTemplatePath;
        ...
        public override System.Collections.Generic.IEnumerable<System.Web.UI.ScriptReference> GetScriptReferences()
        {
            ...
            scripts.Add(new ScriptReference(PhotoLightBoxDesigner.scriptReference));
            return scripts;
        }
        #endregion

        #region Private members & constants
        public static readonly string layoutTemplatePath = "~/Widgets/PhotoLightBox/Designer/PhotoLightBoxDesigner.ascx";
        public const string scriptReference = "~/Widgets/PhotoLightBox/Designer/PhotoLightBoxDesigner.js";
        #endregion
    }
}
